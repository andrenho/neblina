...
TCPServer::TCPServer(uint16_t port, bool open_to_world, size_t buffer_sz)
    : port_(port), open_to_world_(open_to_world), listener_(get_listener_socket()), buffer_sz_(buffer_sz)
{
}
