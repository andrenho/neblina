...
embed.exe: tools\embed\embed.obj src\file\whole_file.obj src\file\gz.obj src\contrib\miniz\miniz.obj src\util\error.obj src\util\logs.obj src\file\gz.obj src\config\args.obj src\os\posix\window.obj
	link /nologo /OUT:$@ $**
